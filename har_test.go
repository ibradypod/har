...
import (
	...
	"github.com/ibradypod/har/proxyutil"
)
...
func TestRecordResponse(t *testing.T) {
	...
	if err := logger.RecordResponse("id", res); err != nil {
...
func TestRecordRequestBodyURLEncoded(t *testing.T) {
	logger := NewLogger()
...
func TestRecordRequestBodyArbitraryContentType(t *testing.T) {
	logger := NewLogger()
...
func TestRecordRequestBodyMultipart(t *testing.T) {
	logger := NewLogger()
...
func TestRecordRequestErrorsOnDuplicateRequest(t *testing.T) {
	logger := NewLogger()
	...
	if logger.RecordRequest("id", req) == nil {
		t.Fatalf("RecordRequest(): was supposed to error")
	}
}
...
func TestExportSortsEntries(t *testing.T) {
	...
	for i := 0; i < count; i++ {
		...
		if err := logger.RecordRequest(strconv.Itoa(i), req); err != nil {
			t.Fatalf("RecordRequest(): got %v, want no error", err)
		}
	}
...
func TestExportAndResetExportsCompleteRequestsWithPendingLeft(t *testing.T) {
	...
	if err := logger.RecordRequest("id1", req); err != nil {
		t.Fatalf("RecordRequest(): got %v, want no error", err)
	}
	...
	if err := logger.RecordRequest("id2", req); err != nil {
		t.Fatalf("RecordRequest(): got %v, want no error", err)
	}
	...
	if err := logger.RecordRequest("id3", req); err != nil {
		t.Fatalf("RecordRequest(): got %v, want no error", err)
	}

	res := proxyutil.NewResponse(200, nil, req)
	if err := logger.RecordResponse("id1", res); err != nil {
		t.Fatalf("ModifyResponse(): got %v, want no error", err)
	}
